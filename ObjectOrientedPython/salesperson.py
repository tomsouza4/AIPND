...
#
###
    def __init__(self, fst_name_prsn, lst_name_prsn, emp_id_prsn, sal_prsn):
        self.first_name = fst_name_prsn
        self.last_name = lst_name_prsn
        self.employee_id = emp_id_prsn
        self.salary = sal_prsn
        self.pants_sold = []
...
###
    def display_sales(self):
        for pnts in self.pants_sold:
            print("color: {}, waist: {}, lenght: {}, price: {}"\
            .format(pnts.color, pnts.waist_size, pnts.length, pnts.price))
