...
#% Correct "Not-a" Dog
    for k in results_stats_dic:
        if k[:3] == 'pct':
            print("%20s: %5.1f" % (k, results_stats_dic[k]))
...
# Prints Incorrectly Classified Dogs as print_incorrect_dogs within
    if (print_incorrect_dogs and
        ...
        for k in results_dic:
            print(sum(results_dic[k][3:]))
            if sum(results_dic[k][3:]) == 1:
                print("Real: %-26s   Classifier: %-30s" % (results_dic[k][0],
                                                          results_dic[k][1]))
    ...
    if (print_incorrect_breed and
        ...
        for k in results_dic:            
            if sum(results_dic[k][3:]) == 2 and results_dic[k][2] == 0:
                print("Real: {:>26}   Classifier: {:>30}".format(results_dic[k][0],
                                                          results_dic[k][1]))   
